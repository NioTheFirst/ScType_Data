...
var Graph = /*#__PURE__*/function () {
  ...
  _proto3.findBestRoute = function findBestRoute(from, to, amountIn, mode) {
    ...
    var status;
    if (step === 0) status = RouteStatus.NoWay;else if (step < routeValues.length) status = RouteStatus.Partial;else status = RouteStatus.Success;
    return {
      status: status,
