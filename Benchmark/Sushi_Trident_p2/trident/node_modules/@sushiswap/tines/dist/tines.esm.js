...
var HybridRPool = /*#__PURE__*/function (_RPool2) {
  ...
  _proto2.computeLiquidity = function computeLiquidity() {
    ...
    var s = r0.add(r1);
    var nA = BigNumber.from(this.A * 2);
    var prevD;
    var D = s;
