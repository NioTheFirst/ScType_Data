...
class NPM {
    ...
    require(import_path, search_path) {
        ...
        var contract_name = path_1.default.basename(import_path, ".sol");
        ...
        var expected_path = path_1.default.join(search_path || this.workingDirectory, "node_modules", package_name, "build", "contracts", contract_name + ".json");
        try {
            var result = fs_1.default.readFileSync(expected_path, "utf8");
    ...
    resolve_dependency_path(import_path, dependency_path) {
        var dirname = path_1.default.dirname(import_path);
        return path_1.default.join(dirname, dependency_path);
    }
}
exports.NPM = NPM;
